...
<div class="be-wrapper be-fixed-sidebar">
    <nav class="navbar navbar-expand fixed-top be-top-header">
        <div class="container-fluid">
            <div class="be-navbar-header"><a class="" href="{{url('/admin/dashboard')}}"><span style="font-size: 24px; color: #ff3b24">SHOP TNB</span></a>
            </div>
            <div class="page-title"><span>Trang quản trị viên</span></div>
            <div class="be-right-navbar">
                <ul class="nav navbar-nav float-right be-user-nav">
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-expanded="false"><img src="{{asset('public/backend/assets/img/avatarfb.jpg')}}" alt="Avatar"><span class="user-name">{{session()->get('admin_name')}}</span></a>
