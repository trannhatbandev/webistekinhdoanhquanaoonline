...
<body>
    ...
    <div class="col-lg-12">
        <h1 style="text-align: center">Bạn đã đặt hàng cho chúng tôi:</h1>
        <h4 style="color:aqua; text-transform:uppercase;">Hôm nay chúng tôi giao hàng thành công, thông tin đơn hàng như sau:</h4>
        ...
        <table class="table table-dark table-hover">
            ...
            <tbody>
                ...
                $totalAfter= 0;
                @endphp
                @foreach($orderListProduct as $value)
                    @php
