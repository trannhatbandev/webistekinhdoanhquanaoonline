...
@section('admin_content')
    ...
    <div class="main-content container-fluid">
        {{-- <div class="row">
            <div class="col-lg-3">
                <form action="{{url('/admin/order/export-pdf')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-6 mb-4" style="display: flex">
                        <button type="submit" class="btn btn-success"><i class="icon mdi mdi-download"> Xuất file PDF</i></button>
                    </div>
                </form>
            </div>
        </div> --}}
