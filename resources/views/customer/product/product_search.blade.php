                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="pro-content">
                                                <div class="pro-info">
                                                    ...
                                                    <p><span class="price">{{$value->product_price_sale}}đ</span><del class="prev-price">{{number_format($value->product_price,0,',','.')}}đ</del></p>
                                                </div>
                                ...
                                <div class="row">
                                    @foreach($productList as $key => $value)
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-12">
                                            ...
                                            <div class="pro-img">
                                                <a href="{{url('/home/product-detail/show-product-detail/'.$value->product_slug)}}">
                                                    <img class="primary-img" id="wistlist_product_image{{$value->product_id}}" src="{{asset('public/uploads/products/'.$value->product_image)}}" alt="single-product">
                                                    <img class="secondary-img" src="{{asset('public/uploads/products/'.$value->product_image)}}" alt="single-product">
                                                </a>
                                                <a class="quick_view" data-product_id="{{$value->product_id}}" data-toggle="modal" data-target="#quick_view" title="Xem nhanh"><i class="lnr lnr-magnifier"></i></a>
                                            </div>
                                        </div>
