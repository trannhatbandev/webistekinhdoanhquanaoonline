                                ...
                                <div class="row">
                                    @foreach($productList as $key => $value)
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-12">
                                            <div class="pro-img">
                                                <a href="{{url('/home/product-detail/show-product-detail/'.$value->product_slug)}}">
                                                    <img class="primary-img" src="{{asset('public/uploads/products/'.$value->product_image)}}" alt="single-product">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-12">
                                            <div class="pro-content hot-product2">
                                                ...
                                                <div class="pro-actions">
                                                    ...
                                                    <div class="actions-secondary">
                                                        <a href="compare.html" title="" data-original-title="Compare"><i class="lnr lnr-sync"></i> <span>So sánh sản phẩm</span></a>
